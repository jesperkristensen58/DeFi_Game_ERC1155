        ...
        <Row>
          ...
          <Col flex="auto">
            <Typography>
              ...
              <Title level={4} style={{ margin: "-30px", fontFamily: "futura" }}>
                <a href="https://opensea.io/collection/the-forge-of-chains">See Collection on OpenSea</a>
              </Title>
              <Title level={4} style={{ margin: "40px", fontFamily: "futura" }}>
                <Button
                  primary
                  shape="round"
                  size="medium"
                  danger
                  href="https://twitter.com/cryptojesperk"
